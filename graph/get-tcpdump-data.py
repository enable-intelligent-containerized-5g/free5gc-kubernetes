...
# Data path
data_path = "data/tcpdump-data.log"
data_filtered_path = "data-filtered/tcpdump-results.pkl"

# Path to the results file
path_tcpdump_results = os.path.join(data_filtered_path)

# Path to the tcpdumpdata
# Use: sudo tcpdump -i <interface-name> > path/to/tcpdumpdata.log
path_tcpdump_data = os.path.join(data_path)
